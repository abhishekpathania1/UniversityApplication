			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active ">
						<a class="nav-link" href="../admin/index.php"><i class="fa fa-home " aria-hidden="true"></i>HOME</a>
					</li>
	...
	?>
		...
		<div class="container">
			<div class="row text-center">
				<div class="col">
					<h1 style="color:white;margin-bottom:30px;">UPDATE STUDENT RECORD.</h1>
				</div>
			</div>
		</div>
		<div class="container">
						...
						<tbody>
							...
							?>
									...
									" . $value['hostel'] . "
											...
											<td>
												<a class='btn btn-warning' href='UpdateRecord.php?id=" . $value['id'] . "' >UPDATE</a>
												</td>	
												</tr>";
										}
										?>
